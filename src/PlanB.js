...
function PlanB() {
  ...
  const [medications, setMedications] = useState([
    // August 24, 2025 medications
    {
      ...
      duration: '2025-08-20 to 2025-08-25',
    },
    {
      id: 2,
      name: 'Insulin Lispro',
      ...
      duration: '2025-08-24 to 2025-08-25',
    },
    {
      id: 3,
      name: 'Lisinopril',
  ...
  const getFilteredMedications = () => {
    return medications.filter((medication) => {
      ...
      return (
        selectedDateOnly >= startDateOnly && selectedDateOnly <= endDateOnly
      );
    });
  };
  ...
  const formatDateForDisplay = (dateString) => {
    ...
    const date = new Date(y, m - 1, d); // parse as local date
  ...
  // Format date for selector value (avoid UTC conversion)
              ...
              <div className='date-selector'>
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    setSelectedDate(new Date(y, m - 1, d)); // set as local date to avoid timezone issues
                  }}
